...
>>>>>>> Stashed changes
            ...
            <p className="footer-description">
              Sua plataforma completa para descobrir, explorar e gerenciar seus
              filmes e séries favoritos.
            </p>
            <div className="social-links">
              <a
                href="https://github.com/leoamff/AnimaCrono"
                aria-label="GitHub"
              >
                <FaGithub />
              </a>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li>
                <a href="https://www.linkedin.com/in/leoamff">
                  Leonardo Amyntas
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/jcjulio20060">
                  Julio César
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/andrezza-coelho">
                  Andrezza Coelho
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/gabriela-caetano-corr%C3%AAa/">
                  Gabriela
                </a>
              </li>
              <li>
