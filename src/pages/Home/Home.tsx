...
const Carousel = () => {
    ...
    // Lógica para verificar o carregamento da imagem
    ...
    return (
        <div className="carousel-container">
            ...
            {/* Conteúdo sobre a imagem (apenas título) */}
            <div className="slide-content">
                <h2>{current.title}</h2>
            </div>
...
export default function Home() {
    ...
    const link90s = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=pt-BR&with_genres=${GENRE_ID_ANIMATION}&primary_release_date.gte=1990-01-01&primary_release_date.lte=1999-12-31&sort_by=popularity.desc`;
    const link2000s = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=pt-BR&with_genres=${GENRE_ID_ANIMATION}&primary_release_date.gte=2000-01-01&primary_release_date.lte=2009-12-31&sort_by=popularity.desc`;
    const link2020s = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=pt-BR&with_genres=${GENRE_ID_ANIMATION}&primary_release_date.gte=2020-01-01&primary_release_date.lte=${endDate}&sort_by=popularity.desc`;
